...
import { fieldAria, FormField, PasswordRules } from '@/components/form'
      ...
      <form onSubmit={(event) => void onSubmit(event)} className="space-y-6" noValidate>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              The email address is how they sign in. Their `@username` is generated by
              the server and cannot be chosen.
            </CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Role labels the account. It does not decide what they can reach — the
              permissions below do, and changing one later leaves the other exactly as
              it was.
            </CardDescription>
          </CardHeader>
          <CardContent>
                ...
                >
                  {STAFF_ROLE_VALUES.map((role) => (
                    <label
                      key={role}
                      htmlFor={`role-${role}`}
                      className="flex cursor-pointer items-center gap-3 rounded-md border border-border bg-surface p-3"
                    >
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Nothing is granted by default. An account with no access here can sign in
              and see the panel shell, and nothing else — a valid, deliberate outcome.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Controller
        ...
        <Card>
          <CardHeader>
            <CardTitle>First password</CardTitle>
            <CardDescription>
